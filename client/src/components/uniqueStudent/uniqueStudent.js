...
class UniqueStudent extends React.Component {
  ...
  onUpload = () => {
    ...
    axios
      .post("/api/student/upload", formData, config)
      .then((response) => {
      ...
      .catch((error) => {
        alert(
          "The file was not successfully uploaded. Please Ensure that the size of the Image is less than 1 Mb and is a valid Image File..."
        );
      });
  };
  onSubmit = () => {
